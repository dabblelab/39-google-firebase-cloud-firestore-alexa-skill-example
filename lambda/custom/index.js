...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = `Hello. Welcome to your list of Countries. To get started, add your favourite country by saying, "add America." `;
